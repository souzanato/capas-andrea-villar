      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            <Image src="/logo-andrea.png" alt="Andrea Villar" width={56} height={61} className="select-none mb-4" />
            <h1 className="text-xl font-medium text-foreground tracking-tight">
              Capas <span className="text-foreground-soft font-normal">Andrea Villar</span>
            </h1>
            <p className="text-sm text-foreground-soft mt-1.5">Confirmar email</p>
            <div
          ...
          {sent ? (
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-foreground">
                Se o email <strong>{email}</strong> estiver cadastrado e não confirmado,
                você receberá um novo link de confirmação.
              </p>
            ...
            <>
              <p className="text-sm text-foreground-soft mb-6 text-center">
              ...
              <div className="mt-6 text-center">
                <Link href="/login" className="text-sm text-foreground-soft underline">
                  Voltar para o login
                </Link>
              </div>
            </>
